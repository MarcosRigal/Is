...
bool existPark(int parkID, list<string> listOfParks);
bool existRoute(int parkID, list<string> listOfParks, int routeID);
bool existTrail(int parkID, list<string> listOfParks, int TrailID);
void intro();
string login();
